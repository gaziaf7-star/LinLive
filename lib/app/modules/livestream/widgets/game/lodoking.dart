...
void LodoKingBottomGameView(BuildContext context) {
  ...
  /*
   IMPORTANT:
   Ludo game URL format:
   http://ludogame.linlive.fr/ludo_king_home/{USER_ID}

   Uri.http er host er moddhe slash (/) dawa jabe na.
   Tai direct Uri.parse use kora holo, jate last e user id thake.
  */
  final String gameUrl =
      'http://ludogame.linlive.fr/ludo_king_home/$userId';

  debugPrint('LUDO KING GAME USER ID => $userId');
  debugPrint('LUDO KING GAME URL => $gameUrl');
