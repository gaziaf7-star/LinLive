...
class Luckyidview extends GetView<StoreController> {
  const Luckyidview({super.key});
            ...
            Expanded(
              child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  // 🔥 FIX: Filter kore shudhu 'Chat Bubble' type er items nibo
                  final filteredList = controller.assetList
                      .where((item) => item['type'] == 'Chat Bubble')
                      .toList();

                  if (filteredList.isEmpty) {
                    return Center(child: Text(("No Chat Bubble assets found").appTr));
                  }
                                            ...
                                            Get.bottomSheet(Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    ('Price : ${controller.assetList[index]['price']}').appTr,
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          Image.asset(
                                                            'assets/images/coin.png', // Replace with your image path
                                                            width: 20,
                                                            height: 20,
                                                          ),
                                                          Text(
                                                            ' ${authController.userProfile.value.user!.coins}',
                                                            // '${controller.assetList[index]['price']}k', // Replace with your dynamic price
                                                            style: GoogleFonts
                                                                .poppins(
                                                              color: Color(
                                                                  0xff793be6),
