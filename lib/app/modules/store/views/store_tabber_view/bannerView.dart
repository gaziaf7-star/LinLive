...
class Bannerview extends GetView<StoreController> {
            ...
            Expanded(
              child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  // 🔥 FIX: Filter kore shudhu 'Banner Frame' type er items nibo
                  final filteredList = controller.assetList
                      .where((item) => item['type'] == 'Banner Frame')
                      .toList();

                  if (filteredList.isEmpty) {
                    return Center(child: Text(("No Banner Frame assets found").appTr));
                  }
