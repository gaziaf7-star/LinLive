...
import 'package:meetlivepro/app/modules/ranking/views/sendingListShow.dart';
...
import '../../../../widgets/after/customRankingcode.dart';
import '../controllers/ranking_controller.dart';
import 'hederRanking/FollowButton.dart';

import 'package:meetlivepro/app/localization/app_localizer.dart';
class AgencyManthlyRankingList extends StatelessWidget {
  const AgencyManthlyRankingList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    informationcollectionController.showAgencyHostList(
        agencyId:
            int.parse(verifiedController.agencySingleData['agency_id'].toString()));
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Obx(() {
            return ListView.builder(
              itemCount:
                  informationcollectionController.newAgencyManthly.length,
              itemBuilder: (BuildContext context, int index) {
                if (index == 0) {
                  final first =
                      informationcollectionController.newAgencyManthly[0];
                  final second =
                      informationcollectionController.newAgencyManthly.length >
                              1
                          ? informationcollectionController.newAgencyManthly[1]
                          : null;
                  final third =
                      informationcollectionController.newAgencyManthly.length >
                              2
                          ? informationcollectionController.newAgencyManthly[2]
                          : null;
                ...
                if (index >= 3) {
                  final item =
                      informationcollectionController.newAgencyManthly[index];
                  return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Castontext(
                                  ...
                                  text: ('Coins :${item['earned_coins']}').appTr)
                            ],
                          ),
                        ),
