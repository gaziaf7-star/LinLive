...
class BdManagerCenterPage extends StatelessWidget {
  const BdManagerCenterPage({super.key});
              ...
              children: [
                Expanded(
                  child: _salaryCard(
                    ...
                    iconColor: const Color(0xFF3598FF),
                    amount: "\$14000",
                    title: ("Total team salary for\nthis month").appTr,
                  ),
                ),
              ...
              children: [
                ...
                Expanded(
                  child: _smallInfoCard(
                    ...
                    iconColor: const Color(0xFF4169FF),
                    title: ("Bank").appTr,
                    subTitle: "3 cards",
                  ),
                ),
              ...
              child: Wrap(
                ...
                children: [
                  _menuItem(
                    ...
                    iconColor: kBlue,
                    title: ("BD member").appTr,
                  ),
                  _menuItem(
                    w: w,
                    icon: Icons.groups_rounded,
                    iconColor: kBlue,
                    title: ("Agent member").appTr,
                  ),
                  _menuItem(
                    w: w,
                    icon: Icons.card_giftcard_rounded,
                    iconColor: const Color(0xFFFF9800),
                    title: ("Invite agent").appTr,
                  ),
                  _menuItem(
                    w: w,
                    icon: Icons.person_rounded,
                    iconColor: const Color(0xFF00BCD4),
                    title: ("Invite BD").appTr,
                  ),
                ],
              ),
            ),
